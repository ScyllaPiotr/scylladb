...
=========  =========================================================================================
AUTH       Logs login events (CQL only)
---------  -----------------------------------------------------------------------------------------
DML        Logs insert, update, delete, and other data manipulation language (DML) events.
           Covers both CQL and Alternator operations (see :ref:`alternator-auditing`).
---------  -----------------------------------------------------------------------------------------
DDL        Logs object and role create, alter, drop, and other data definition language (DDL) events.
           Covers both CQL and Alternator operations (see :ref:`alternator-auditing`).
---------  -----------------------------------------------------------------------------------------
DCL        Logs grant, revoke, create role, drop role, and list roles events (CQL only)
---------  -----------------------------------------------------------------------------------------
...
When auditing is enabled, Alternator (DynamoDB-compatible API) requests are audited using the same backends
(Syslog and/or table) and the same filtering configuration (``audit_categories``, ``audit_keyspaces``,
